describe('tag catalog', () => {
  ...
  it ('Tag catalog', function () {
    ...
    cy.get('#logonuidfield').type(this.testdata.username)
    cy.get('#logonpassfield').type(this.testdata.password)
    ...
    //cy.get('#__xmlview4--input-renamed-tag-1-vhi').click()
    //cy.wait(2000)
    // cy.get('#__xmlview4--combobox-domain-inner').type('Pharma{enter}',{force: true})
    // cy.wait(2000)
