describe('template spec', () => {
    ...
    it('Flat File', function () {
      ...
      //  cy.get('#__item303-imgNav').click({force: true})
      ...
      //  cy.get('#__button30-inner').click({force: true})
       ...
       cy.wait(2000)
       cy.get('#__item342-selectSingle').click({force: true})
       ...
       cy.get('#__icon7-__clone322').should('have.css', 'color', 'rgb(255, 0, 0)')
       cy.wait(2000)
       cy.get('#__button20-BDI-content').click()
       cy.wait(2000)
       cy.get('#__xmlview5--combobox-data-source-arrow').click()
       cy.get('#__xmlview5--combobox-data-source-popup-list-listUl>li').each(($e,index)=>{
         if ($e.text() === this.EPIC_Flat_File.DataSourceName) {
            cy.wrap($e).click({force: true})}
            }) 
       cy.get('#__xmlview5--input-data-flow-name-inner').type(this.EPIC_Flat_File.DataFlowName2)
       cy.get('#__xmlview5--input-description-inner').type(this.EPIC_Flat_File.Description)
       ...
       cy.get('#__xmlview5--switch-transformation-handle').click()
       cy.wait(2000)
       cy.get('#__xmlview5--combobox-fileInputFormat-arrow').click()
       cy.get('#__xmlview5--combobox-fileInputFormat-popup-list-listUl>li').each(($e,index)=>{
         if ($e.text() === this.EPIC_Flat_File.InputFormat) {
            cy.wrap($e).click({force: true})}
            }) 
       cy.wait(2000)
       cy.get('#__xmlview5--combobox-fileOutputFormat-arrow').click()
       cy.get('#__xmlview5--combobox-fileOutputFormat-popup-list-listUl>li').each(($e,index)=>{
         if ($e.text() === this.EPIC_Flat_File.OutputFormat) {
            cy.wrap($e).click({force: true})}
            }) 
       cy.get('#__button25-BDI-content').click()
       cy.wait(2000)
       ...
       cy.get('#__xmlview5--combobox-data-source-arrow').click()
       cy.get('#__xmlview5--combobox-data-source-popup-list-listUl>li').each(($e,index)=>{
         if ($e.text() === this.EPIC_Flat_File.DataSourceName_2) {
            cy.wrap($e).click({force: true})}
            }) 
       cy.get('#__xmlview5--input-data-flow-name-inner').type(this.EPIC_Flat_File.DataFlowName3)
       cy.get('#__xmlview5--input-description-inner').type(this.EPIC_Flat_File.Description)
       cy.get('#__xmlview5--input-pco-destination-id-inner').type(this.EPIC_Flat_File.PcoDestinationID)
       cy.get('#__xmlview5--combobox-datadestination-arrow').click()
       cy.get('#__xmlview5--combobox-datadestination-popup-list-listUl>li').each(($e,index)=>{
       ...
       cy.get('#__xmlview5--combobox-fileInputFormat-arrow').click()
       cy.get('#__xmlview5--combobox-fileInputFormat-popup-list-listUl>li').each(($e,index)=>{
         if ($e.text() === this.EPIC_Flat_File.InputFormat1) {
            cy.wrap($e).click({force: true})}
            }) 
       cy.get('#__xmlview5--combobox-fileOutputFormat-arrow').click()
       cy.get('#__xmlview5--combobox-fileOutputFormat-popup-list-listUl>li').each(($e,index)=>{
       ...
       cy.get('#__button1').click()
       cy.wait(3000)
       cy.get('#__icon7-__clone324').should('have.css', 'color', 'rgb(255, 0, 0)')
